...
const resourceLinks = [
  { href: 'https://letsmesh.net', label: 'LetsMesh', external: true },
  { href: 'https://meshcore.co', label: 'MeshCore', external: true },
];
...
export default function Footer() {
  ...
  return (
    <footer className="bg-night-900 text-snow-100" role="contentinfo">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            <Link
              href="/"
              className="inline-flex items-center gap-2 group focus-ring rounded-md"
            ...
            >
              ...
              <div className="flex flex-col">
                <span className="text-xl font-bold text-snow-100 leading-tight">
                  Denver
                </span>
                <span className="text-base font-medium text-mesh leading-tight">
                  MeshCore
                </span>
              </div>
            </Link>
            <p className="mt-4 text-snow-300 text-sm leading-relaxed">
              Building Colorado&apos;s decentralized mesh network community.
              Connect, communicate, and stay resilient with off-grid
            ...
            <a
              ...
              className="mt-6 inline-flex items-center gap-2 btn-accent text-sm focus-ring"
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-sm font-semibold text-snow-100 uppercase tracking-wider">
              Quick Links
            </h3>
        ...
        <div className="mt-12 pt-8 border-t border-night-700">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <p className="text-sm text-snow-400">
              &copy; {currentYear} Denver MeshCore Community. All rights reserved.
            </p>

            {/* Open Source Link */}
            <a
              href="https://github.com/Denver-MeshCore/denvermc"
              target="_blank"
              rel="noopener noreferrer"
